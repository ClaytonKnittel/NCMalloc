...
class argument_parser {
    ...
    void EXIT_FUNC exit_usage_success() const;

    // various exit function in case of a variety of errors
    void EXIT_FUNC exit_missing_error() const;
    void EXIT_FUNC exit_usage_error(exit_codes error, const char * fmt, ...) const;
    void EXIT_FUNC exit_error(exit_codes error, argument_info bad_argument) const;
